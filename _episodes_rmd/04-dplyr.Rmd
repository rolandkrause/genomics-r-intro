...
then load it to be able to use it. The **`tidverse`** package is a package of packages comprising many useful packages that use the pipe operator and share other commonalities. **`ggplot2`** is another package that we see later. If you prepared the training, **`tidverse`** should already be installed.
...
The package `dplyr` is a package that tries to provide easy
